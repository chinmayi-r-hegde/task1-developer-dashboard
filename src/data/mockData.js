// Mock data — shaped EXACTLY like the real API responses will be
// (see the REST contract: GET /projects, GET /projects/:id/tasks)
// When Task 2/3 are done, hooks/useProjects.js and hooks/useTasks.js
// swap to real fetch calls — no component below ever needs to change.

// Customer support contact, shown in the footer / support panel.
